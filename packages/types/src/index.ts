...
export interface BorderStyleProps {
  /**
   * @description Add a border radius to all corners of the box.
   * @tailwind rounded
   */
  rounded?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to both top corners of the box.
   * @tailwind rounded-t
   */
  roundedTop?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to both bottom corners of the box.
   * @tailwind rounded-b
   */
  roundedBottom?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to both start corners of the box.
   * @tailwind rounded-s
   */
  roundedStart?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to both end corners of the box.
   * @tailwind rounded-e
   */
  roundedEnd?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to top left corner of the box.
   * @tailwind rounded-ss
   */
  roundedTopStart?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to top right corner of the box.
   * @tailwind rounded-se
   */
  roundedTopEnd?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to bottom left corner of the box.
   * @tailwind rounded-es
   */
  roundedBottomStart?: BorderRadius | ArbitraryValue;
  /**
   * @description Add a border radius to bottom right corner of the box.
   * @tailwind rounded-ee
   */
  roundedBottomEnd?: BorderRadius | ArbitraryValue;
  /**
   * @description Adds a custom border color
   * @tailwind border
   */
  borderColor?: Color;
  /**
   * @description Adds a custom border color vertically
   * @tailwind border-y
   */
  borderYColor?: Color;
  /**
   * @description Adds a custom border color horizontally
   * @tailwind border-x
   */
  borderXColor?: Color;
  /**
   * @description Adds a custom start border color
   * @tailwind border-s
   */
  borderStartColor?: Color;
  /**
   * @description Adds a custom left border color
   * @tailwind border-l
   */
  borderLeftColor?: Color;
  /**
   * @description Adds a custom end border color
   * @tailwind border-e
   */
  borderEndColor?: Color;
  /**
   * @description Adds a custom right border color
   * @tailwind border-r
   */
  borderRightColor?: Color;
  /**
   * @description Adds a custom top border color
   * @tailwind border-t
   */
  borderTopColor?: Color;
  /**
   * @description Adds a custom bottom border color
   * @tailwind border-b
   */
  borderBottomColor?: Color;
  /**
   * @description Utility for adding border to an element
   * @tailwind border
   */
  border?: boolean;
  /**
   * @description Utility for adding border bottom to an element
   * @tailwind border-b
   */
  borderBottom?: boolean;
  /**
   * @description Utility for adding border top to an element
   * @tailwind border-t
   */
  borderTop?: boolean;
  /**
   * @description Utility for adding border left to an element
   * @tailwind border-l
   */
  borderLeft?: boolean;
  /**
   * @description Utility for adding border right to an element
   * @tailwind border-r
   */
  borderRight?: boolean;
  /**
   * @description Utility for adding border start to an element
   * @tailwind border-s
   */
  borderStart?: boolean;
  /**
   * @description Utility for adding border end to an element
   * @tailwind border-e
   */
  borderEnd?: boolean;
  /**
  ...
  borderY?: boolean;
  /**
   * @description Shorthand property to the width of an element's border.
   * @tailwind border
   */
  borderWidth?: BorderWidth;
  /**
   * @description Sets the width of the top and bottom border of an element.
   * @tailwind border-y
   */
  borderYWidth?: BorderWidth;
  /**
   * @description Sets the width of the start (left) and end (right) border of an element.
   * @tailwind border-x
   */
  borderXWidth?: BorderWidth;
  /**
   * @description Sets the width of the start (left) border of an element.
   * @tailwind border-s
   */
  ...
  /**
   * @description Sets the width of the end (right) border of an element.
   * @tailwind border-e
   */
  ...
  /**
   * @description Inset the outline ring box shadow
   * @tailwind ring-inset
   */
  ringInset?: boolean;
}
...
export interface LayoutStyleProps {
  ...
  /**
   * @description Shorthand property which sets the desired behavior when content does not fit in the parent element box (overflows) in the horizontal and/or vertical direction.
   * @tailwind overflow
   */
  overflow?: Overflow;
  /**
   * @description Sets what shows when content overflows a block-level element's left and right edges. This may be nothing, a scroll bar, or the overflow content. This property may also be set by using the overflow shorthand property.
   * @tailwind overflow-x
   */
  overflowX?: Overflow;
  /**
   * @description sets what shows when content overflows a block-level element's top and bottom edges. This may be nothing, a scroll bar, or the overflow content. This property may also be set by using the overflow shorthand property.
   * @tailwind overflow-y
   */
  overflowY?: Overflow;
  /**
  ...
  position?: Position;
  /**
   * @description Utilities for controlling the top placement of positioned elements
   * @tailwind top
   */
  top?: PositionPlacement | ArbitraryValue;
  /**
   * @description Utilities for controlling the bottom placement of positioned elements
   * @tailwind bottom
   */
  bottom?: PositionPlacement | ArbitraryValue;
  /**
   * @description Utilities for controlling the left placement of positioned elements
   * @tailwind left
   */
  left?: PositionPlacement | ArbitraryValue;
  /**
   * @description Utilities for controlling the right placement of positioned elements
   * @tailwind right
   */
  right?: PositionPlacement | ArbitraryValue;
  /**
   * @description Utilities for controlling the inset of positioned elements
   * @tailwind inset
   */
...
export interface TransformStyleProps {
  /**
   * @description Utilities for controlling the scale of an element.
   * @tailwind scale
   */
  ...
  /**
   * @description Utilities for controlling the rotate of an element.
   * @tailwind rotate
   */
  rotate?: Rotate | ArbitraryValue;
  /**
   * @description Utilities for controlling the skew of an element.
   * @tailwind skew-x
   */
  ...
  skewY?: Skew;
  /**
   * @description Utilities for controlling the translate of an element.
  ...
  /**
   * @description Utilities for controlling the origin of an element.
   * @tailwind origin
   */
...
export interface SpacingStyleProps {
  /**
   * @description Apply inner spacing on all sides.
   * @tailwind p
   */
  spacing?: SpacingAlias | ArbitraryValue;
  /**
   * @description Apply inner spacing on the leading and trailing sides.
   * @tailwind px
   */
  spacingX?: SpacingAlias | ArbitraryValue;
  /**
   * @description Apply inner spacing on the top and bottom sides.
   * @tailwind py
   */
  spacingY?: SpacingAlias | ArbitraryValue;
  /**
   * @description Apply inner spacing on the trailing side.
   * @tailwind pr
   */
  spacingRight?: SpacingAlias | ArbitraryValue;
  /**
   * @description Apply inner spacing on the leading side.
   * @tailwind pe
   */
  ...
  /**
   * @description Apply inner spacing on the top side.
   * @tailwind pt
   */
  spacingTop?: SpacingAlias | ArbitraryValue;
  /**
   * @description Apply negative outer spacing on all sides.
   * @tailwind -m
   */
  /**
   * @description Apply inner spacing on the bottom side.
   * @tailwind pb
   */
  spacingBottom?: SpacingAlias | ArbitraryValue;
  /**
   * @description Apply negative outer spacing to all sides.
   * @tailwind -m
   */
  offset?: SpacingAlias | ArbitraryValue | 'auto';
  /**
   * @description Apply negative outer spacing on the top and bottom sides.
   * @tailwind -my
   */
  offsetY?: SpacingAlias | ArbitraryValue | 'auto';
  /**
   * @description Apply negative outer spacing on the leading and trailing sides.
   * @tailwind -mx
   */
  offsetX?: SpacingAlias | ArbitraryValue | 'auto';
  /**
   * @description Apply negative outer spacing on the bottom side.
   * @tailwind -mb
   */
  offsetBottom?: SpacingAlias | ArbitraryValue | 'auto';
  /**
   * @description Apply negative outer spacing on the trailing side.
   * @tailwind -me
   */
  ...
  /**
   * @description Apply negative outer spacing on the leading side.
   * @tailwind -ms
   */
  ...
  /**
   * @description Apply negative outer spacing on the top side.
   * @tailwind -mt
   */
  ...
  /**
   * @description Control the horizontal gutters between grid and flexbox items. If set to auto, will add an equal space between items.
   * @tailwind gap-x
   */
  gapX?: SpacingAlias | ArbitraryValue;
  /**
   * @description Control the vertical gutters between grid and flexbox items. If set to auto, will add an equal space between items.
   * @tailwind gap-y
   */
  gapY?: SpacingAlias | ArbitraryValue;
  /**
   * @description Utilities for controlling the spacing between elements.
   * @tailwind space-x
   */
...
export interface FlexStyleProps {
  ...
  flexGrow?: FlexGrow;
  /**
   * @description Sets the flex shrink factor of a flex item. If the size of all flex items is larger than the flex container, items shrink to fit according to flex-shrink.
   * @tailwind shrink
   */
  ...
  /**
   * @description Sets the align-self value on all direct children as a group. In Flexbox, it controls the alignment of items on the Cross Axis. In Grid Layout, it controls the alignment of items on the Block Axis within their grid area.
   * @tailwind items
   */
  ...
  alignSelf?: AlignSelf;
  /**
   * @description Sets the distribution of space between and around content items along a flexbox's cross-axis or a grid's block axis.
   * @tailwind content
   */
...
export interface GridStyleProps {
  ...
  /**
   * @description Utilities for controlling the start and end of a grid column.
   * @tailwind col-start
   */
  gridColumnStart?: GridColumnStart;
  /**
   * @description Utilities for controlling the start of a grid column.
   * @tailwind col-end
   */
  ...
  /**
   * @description Utilities for controlling the start of a grid row.
   * @tailwind row-start
   */
  gridRowStart?: GridRowStart;
  /**
   * @description Utilities for controlling the end of a grid row.
   * @tailwind row-end
   */
...
export interface TypographyStyleProps {
  /**
   * @description Utility for setting bundle of typography styles such as font size, line height & font weight
   * @tailwind text-variant
   */
  textVariant?: TextVariant;
  /**
   * @description Utility for controlling the color of a Text or Icon element
   * @tailwind text
   */
  color?: Color;
  /**
   * @description Utility for controlling the font family of a Text element
   * @tailwind font
   */
  fontFamily?: FontFamily;
  /**
   * @description Utility for controlling the font size of a Text element
   * @tailwind text
   */
  ...
  /**
   * @description Utility for controlling the font weight of a Text element
   * @tailwind font-weight
   */
  fontWeight?: number;
  /**
   * @description Utility for controlling the line height of a Text element
   * @tailwind leading
   */
  lineHeight?: LineHeight | ArbitraryValue;
  /**
   * @description Utility for controlling the text alignment of a Text element
   * @tailwind text
   */
  textAlign?: TextAlign;
  /**
   * @description Utility for controlling the text transformation of a Text element
  ...
  /**
   * @description Prevent text from wrapping and truncate overflowing text with an ellipsis (…) if needed.
   * @tailwind truncate
   */
  truncate?: boolean;
  /**
   * @description Utilities for controlling how text is wrapped.
   * @tailwind text
   */
  textWrap?: TextWrap;
  /**
  ...
  /**
   * @description Utilities for controlling how text is white spaced.
   * @tailwind whitespace
   */
  whitespace?: TextWhitespace;
  /**
   * @description Utilities for controlling how text is broken into lines.
   * @tailwind break
   */
  break?: TextWordBreak;
  /**
   * @description Utilities for controlling hyphenation of text.
   * @tailwind hyphens
   */
  hyphens?: TextHyphens;
}
...
export interface BackgroundStyleProps {
  /**
   * @description Utility for controlling an element's background color.
   * @tailwind bg
   */
  bg?: Color;
}
...
export interface SvgStyleProps {
  /**
   * @description Utilities for controlling the color of an SVG element.
   * @tailwind fill
   */
  fill?: Color;
  /**
  ...
  strokeColor?: Color;
  /**
   * @description Utilities for controlling the width of an SVG element.
   * @tailwind stroke
   */
...
export interface InteractivityStyleProps {
  ...
  /**
   * @description Utilities for controlling the scroll offset around all sides of outside of snap container.
   * @tailwind scroll-m
   */
  scrollSnapGap?: ScrollSnapGap;
  /**
   * @description Utilities for controlling the scroll offset around top side of outside of snap container.
   * @tailwind scroll-mt
   */
  scrollSnapGapTop?: ScrollSnapGap;
  /**
   * @description Utilities for controlling the scroll offset around bottom side of outside of snap container.
   * @tailwind scroll-mb
   */
  scrollSnapGapBottom?: ScrollSnapGap;
  /**
   * @description Utilities for controlling the scroll offset around start side of outside of snap container.
   * @tailwind scroll-ms
   */
  scrollSnapGapStart?: ScrollSnapGap;
  /**
   * @description Utilities for controlling the scroll offset around end side of outside of snap container.
   * @tailwind scroll-me
   */
  scrollSnapGapEnd?: ScrollSnapGap;
  /**
   * @description Utilities for controlling the scroll offset around horizontal sides of outside of snap container.
   * @tailwind scroll-mx
   */
  scrollSnapGapX?: ScrollSnapGap;
  /**
   * @description Utilities for controlling the scroll offset around vertical sides of outside of snap container.
   * @tailwind scroll-my
   */
  ...
  /**
   * @description Utilities for controlling the scroll offset around top side within snap container.
   * @tailwind scroll-pt
   */
  scrollSnapSpacingTop?: ScrollSnapSpacing;
  /**
   * @description Utilities for controlling the scroll offset around bottom side within snap container.
   * @tailwind scroll-pb
   */
  scrollSnapSpacingBottom?: ScrollSnapSpacing;
  /**
   * @description Utilities for controlling the scroll offset around start side within snap container.
   * @tailwind scroll-ps
   */
  scrollSnapSpacingStart?: ScrollSnapSpacing;
  /**
   * @description Utilities for controlling the scroll offset around end side within snap container.
   * @tailwind scroll-pe
   */
  scrollSnapSpacingEnd?: ScrollSnapSpacing;
  /**
   * @description Utilities for controlling the scroll offset around horizontal sides within snap container.
   * @tailwind scroll-px
   */
  scrollSnapSpacingX?: ScrollSnapSpacing;
  /**
   * @description Utilities for controlling the scroll offset around vertical sides within snap container.
   * @tailwind scroll-py
   */
...
export interface TableStyleProps {
  ...
  /**
   * @description Utilities for controlling the spacing between cells in a table.
   * @tailwind border-spacing
   */
  tableBorderSpacing?: TableBorderSpacing;
  /**
   * @description Utilities for controlling the spacing horizontally of cells in a table.
   * @tailwind border-spacing-x
   */
  tableBorderSpacingX?: TableBorderSpacing;
  /**
   * @description Utilities for controlling the spacing vertically of cells in a table.
   * @tailwind border-spacing-y
   */
  tableBorderSpacingY?: TableBorderSpacing;
  /**
   * @description Utilities for controlling the layout of a table.
   * @tailwind table
   */
  tableLayout?: TableLayout;
  /**
   * @description Utilities for controlling the side of a table caption.
   * @tailwind caption
   */
...
export interface GroupStyleProps {
  /**
   * @description When you need to style an element based on the state of some parent element, mark the parent with the group class, and use group-* modifiers like group-hover to style the target element
   * @tailwind group
   */
...
export interface ModifierProps<T = AllStyleProps> {
  /**
   * @description Conditionally add styles to after pseudo element
   * @tailwind after:
   */
  _after?: Omit<StyleProps<T>, '_after'>;
  /**
   * @description Conditionally add styles when the user is only in dark mode
   * @tailwind dark:
   */
  _dark?: Omit<StyleProps<T>, '_dark'>;
  /**
   * @description Conditionally apply utility classes hover state
   * @tailwind hover:
   */
  _hover?: Omit<StyleProps<T>, '_hover'>;
  /**
   * @description Conditionally apply utility classes focus state
   * @tailwind focus:
   */
  _focus?: Omit<StyleProps<T>, '_focus'>;
  /**
   * @description Conditionally apply utility classes focus within state
   * @tailwind focus-within:
   */
  _focusWithin?: Omit<StyleProps<T>, '_focusWithin'>;
  /**
   * @description Conditionally apply utility classes focus visible state
   * @tailwind focus-visible:
   */
  _focusVisible?: Omit<StyleProps<T>, '_focusVisible'>;
  /**
   * @description Conditionally apply utility classes active state
   * @tailwind active:
   */
  _active?: Omit<StyleProps<T>, '_active'>;
  /**
   * @description Conditionally style a link when it has already been visited
   * @tailwind visited:
   */
  _visited?: Omit<StyleProps<T>, '_visited'>;
  /**
   * @description Style an element if its ID matches the current URL fragment
   * @tailwind target:
   */
  _target?: Omit<StyleProps<T>, '_target'>;
  /**
   * @description Conditionally apply utility classes to first child
   * @tailwind first:
   */
  _first?: Omit<StyleProps<T>, '_first'>;
  /**
   * @description Conditionally apply utility classes to last child
   * @tailwind last:
   */
  _last?: Omit<StyleProps<T>, '_last'>;
  /**
   * @description Style an element if it's the only child
   * @tailwind only:
   */
  _only?: Omit<StyleProps<T>, '_only'>;
  /**
   * @description Conditionally apply utility classes to odd child
   * @tailwind odd:
   */
  _odd?: Omit<StyleProps<T>, '_odd'>;
  /**
   * @description Conditionally apply utility classes to even child
   * @tailwind even:
   */
  _even?: Omit<StyleProps<T>, '_even'>;
  /**
   * @description Style an element if it's the first child of its type
   * @tailwind first-of-type:
   */
  _firstOfType?: Omit<StyleProps<T>, '_firstOfType'>;
  /**
   * @description Style an element if it's the last child of its type
   * @tailwind last-of-type:
   */
  _lastOfType?: Omit<StyleProps<T>, '_lastOfType'>;
  /**
   * @description Style an element if it's the only child of its type
   * @tailwind only-of-type:
   */
  _onlyOfType?: Omit<StyleProps<T>, '_onlyOfType'>;
  /**
   * @description Style an element if it has no content
   * @tailwind empty:
   */
  _empty?: Omit<StyleProps<T>, '_empty'>;
  /**
   * @description Conditionally apply utility classes disabled state
   * @tailwind disabled:
   */
  _disabled?: Omit<StyleProps<T>, '_disabled'>;
  /**
   * @description Style an input when it's enabled using the enabled modifier
   * @tailwind enabled:
   */
  _enabled?: Omit<StyleProps<T>, '_enabled'>;
  /**
   * @description Conditionally apply utility classes checked state
   * @tailwind checked:
   */
  _checked?: Omit<StyleProps<T>, '_checked'>;
  /**
   * @description Style a checkbox or radio button in an indeterminate state
   * @tailwind indeterminate:
   */
  _indeterminate?: Omit<StyleProps<T>, '_indeterminate'>;
  /**
   * @description Style an option, checkbox or radio button that was the default value when the page initially loaded
   * @tailwind default:
   */
  _default?: Omit<StyleProps<T>, '_default'>;
  /**
   * @description Style an input when it's required
   * @tailwind required:
   */
  _required?: Omit<StyleProps<T>, '_required'>;
  /**
   * @description Style an input when it's valid
   * @tailwind valid:
   */
  _valid?: Omit<StyleProps<T>, '_valid'>;
  /**
   * @description Style an input when it's invalid
   * @tailwind invalid:
   */
  _invalid?: Omit<StyleProps<T>, '_invalid'>;
  /**
   * @description Style an input when its value is within a specified range limit
   * @tailwind in-range:
   */
  _inRange?: Omit<StyleProps<T>, '_inRange'>;
  /**
   * @description Style an input when its value is outside of a specified range limit
   * @tailwind out-of-range:
   */
  _outOfRange?: Omit<StyleProps<T>, '_outOfRange'>;
  /**
   * @description Style an input when the placeholder is shown
   * @tailwind placeholder-shown:
   */
  _placeholderShown?: Omit<StyleProps<T>, '_placeholderShown'>;
  /**
   * @description Style an input when it has been autofilled by the browser
   * @tailwind autofill:
   */
  _autofill?: Omit<StyleProps<T>, '_autofill'>;
  /**
   * @description Style an input when it is read-only
   * @tailwind read-only:
   */
  _readonly?: Omit<StyleProps<T>, '_readonly'>;
  /**
   * @description Style the button in file inputs
   * @tailwind file:
   */
  _file?: Omit<StyleProps<T>, '_file'>;
  /**
   * @description Style the active text selection
   * @tailwind selection:
   */
  _selection?: Omit<StyleProps<T>, '_selection'>;
  /**
   * @description Style the backdrop of a native <dialog> element
   * @tailwind backdrop:
   */
  _backdrop?: Omit<StyleProps<T>, '_backdrop'>;
  /**
   * @description Conditionally apply utility classes to the sm breakpoint and above.
   * @tailwind sm:
   */
  _sm?: Omit<StyleProps<T>, '_sm'>;
  /**
   * @description Conditionally apply utility classes to the md breakpoint and above.
   * @tailwind md:
   */
  _md?: Omit<StyleProps<T>, '_md'>;
  /**
   * @description Conditionally apply utility classes to the lg breakpoint and above.
   * @tailwind lg:
   */
  _lg?: Omit<StyleProps<T>, '_lg'>;
  /**
   * @description Conditionally apply utility classes to the xl breakpoint and above.
   * @tailwind xl:
   */
  _xl?: Omit<StyleProps<T>, '_xl'>;
  /**
   * @description Conditionally apply utility classes to the 2xl breakpoint and above.
   * @tailwind 2xl:
   */
  _2xl?: Omit<StyleProps<T>, '_2xl'>;
  /**
   * @description Conditionally add styles when the user has requested reduced motion
   * @tailwind motion-reduce:
   */
  _motionReduce?: Omit<StyleProps<T>, '_motionReduce'>;
  /**
   * @description Modifier that only adds styles when the user has not requested reduced motion
   * @tailwind motion-safe:
   */
  _motionSafe?: Omit<StyleProps<T>, '_motionSafe'>;
  /**
   * @description Modifier to conditionally add styles when the user has requested more contrast
   * @tailwind contrast-more:
   */
  _contrastMore?: Omit<StyleProps<T>, '_contrastMore'>;
  /**
   * @description Modifier you can use to conditionally add styles when the user has requested less contrast
   * @tailwind contrast-less:
   */
  _contrastLess?: Omit<StyleProps<T>, '_contrastLess'>;
  /**
   * @description Modifier to conditionally add styles when the user has enabled a forced color mode
  ...
  /**
   * @description Modifier to conditionally add styles that indicate the "busy" state
   * @tailwind aria-busy:
   */
  _ariaBusy?: Omit<StyleProps<T>, '_ariaBusy'>;
  /**
   * @description Modifier to conditionally add styles that indicate the "checked" state
   * @tailwind aria-checked:
   */
  _ariaChecked?: Omit<StyleProps<T>, '_ariaChecked'>;
  /**
   * @description Modifier to conditionally add styles that indicate the "hidden" state
   * @tailwind aria-hidden:
   */
  _ariaHidden?: Omit<StyleProps<T>, '_ariaHidden'>;
  /**
   * @description Modifier to conditionally add styles that indicate the "pressed" state
   * @tailwind aria-pressed:
   */
  _ariaPressed?: Omit<StyleProps<T>, '_ariaPressed'>;
  /**
   * @description Modifier to conditionally add styles that indicate the "readonly" state
   * @tailwind aria-readonly:
   */
  _ariaReadonly?: Omit<StyleProps<T>, '_ariaReadonly'>;
  /**
   * @description Modifier to conditionally add styles that indicate the "required" state
   * @tailwind aria-required:
   */
  _ariaRequired?: Omit<StyleProps<T>, '_ariaRequired'>;
  /**
   * @description Modifier to conditionally add styles that indicate the current "selected" state of various widgets
   * @tailwind aria-selected:
   */
  _ariaSelected?: Omit<StyleProps<T>, '_ariaSelected'>;
  /**
   * @description Modifier to conditionally apply styles when element is disabled
   * @tailwind aria-disabled:
   */
  _ariaDisabled?: Omit<StyleProps<T>, '_ariaDisabled'>;
  /**
   * @description Modifier to conditionally apply styles when element is expanded
  ...
  /**
   * @description Conditionally add styles to cmdk group
   * @tailwind cmdkGroup:
   */
  _cmdkGroup?: Omit<StyleProps<T>, '_cmdkGroup'>;
  /**
   * @description Conditionally add styles to cmdk group heading
  ...
  /**
   * @description Conditionally add styles to cmdk group item
   * @tailwind cmdkItem:
   */
  _cmdkItem?: Omit<StyleProps<T>, '_cmdkItem'>;
  /**
   * @description Conditionally add styles to cmdk input
   * @tailwind cmdkItemSvg:
   */
  _cmdkItemSvg?: Omit<StyleProps<T>, '_cmdkItemSvg'>;
  /**
   * @description Conditionally add styles to cmdk input wrapper
   * @tailwind cmdkInput:
   */
...
export interface UniversalTextProps extends StyleProps, AsChildProps {
  /**
   * @description The text variant to use. */
  variant?: TextVariant;
}

export interface UniversalPressableProps extends StyleProps, AsChildProps {
  /**
   * @description Callback function called when the element is pressed. */
  onPress?: () => void;
}
...
export interface UniversalImageProps extends StyleProps, AsChildProps {
  ...
  src?: string;
  /**
   * @description Provides fallback (alternate) text to display when the image specified by the Image element is not loaded. */
  alt?: string;
}
...
export interface IconStyleProps
  ...
  > {
  /**
   * @description TODO: dynamically get icon names from icon font */
  name: IconName;
}
