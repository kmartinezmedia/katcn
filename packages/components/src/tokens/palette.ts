...
const lightPalette: PaletteConfig = {
  ...
  backgroundWash: {
    alert: { hue: 'red', step: '100' },
    brand: { hue: 'purple', step: '100' },
    accent: { hue: 'blue', step: '100' },
    positive: { hue: 'green', step: '100' },
    warning: { hue: 'orange', step: '100' },
  },
  elevation: {
    '1': { hue: 'stone', step: '50' },
    '2': { hue: 'stone', step: '50' },
...
const darkPalette: PaletteConfig = {
  ...
  backgroundWash: {
    alert: { hue: 'red', step: '900' },
    brand: { hue: 'purple', step: '900' },
    accent: { hue: 'blue', step: '900' },
    positive: { hue: 'green', step: '900' },
    warning: { hue: 'orange', step: '900' },
  },
  elevation: {
    '1': { hue: 'stone', step: '800' },
    '2': { hue: 'stone', step: '700' },
    '3': { hue: 'stone', step: '600' },
